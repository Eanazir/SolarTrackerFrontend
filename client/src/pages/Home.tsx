...
import systemImg from '../assets/Solar Tracker System.jpg';
...
const Home: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-start min-h-screen bg-white dark:bg-gray-900 transition-colors duration-500 p-6 pt-12">
      ...
      <h1 className="text-5xl font-extrabold text-gray-800 dark:bg-gradient-to-r dark:from-orange-500 dark:to-orange-300 pb-6 text-center bg-gradient-to-r from-blue-600 to-blue-400 bg-clip-text text-transparent transition-all duration-500">
        Solar Irradiance Monitoring System
      </h1>

      {/* Project Description with Better Readability */}
      <p className="text-xl text-gray-700 dark:text-gray-300 max-w-3xl text-center mb-8 leading-relaxed">
        Our project focuses on creating a cost-effective, real-time solar
        irradiance forecasting system to address the challenges of integrating
        solar energy into modern power grids. By combining sky imaging
        technology, advanced sensors, and machine learning, the system captures
        and analyzes real-time data to deliver accurate solar forecasts.
        Designed to operate in remote, harsh environments, the device is
        solar-powered, weatherproof, and built with open-source hardware and
        software for affordability. This innovative solution aims to enhance
        grid stability, optimize energy market decisions, and support a
        sustainable energy future.
      </p>

      {/* Team Members and Live Image in Enhanced Container */}
      <div className="w-full max-w-6xl mb-8 flex flex-col items-center md:flex-row md:items-start justify-between space-y-8 md:space-y-0 md:space-x-4 mx-auto">
        {/* Team Members Section */}
        <div className="flex-1 bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg">
          <h2 className="text-3xl font-semibold text-gray-800 dark:text-gray-100 mb-6 flex justify-center md:text-left border-b pb-2 border-gray-200 dark:border-gray-700">
            Meet the Team
          </h2>
        ...
        <div className="flex-1 bg-white dark:bg-gray-800 rounded-xl p-8 mb-8 shadow-lg">
          <h2 className="text-3xl font-semibold text-gray-800 dark:text-gray-100 mb-6 flex justify-center md:text-left border-b pb-2 border-gray-200 dark:border-gray-700">
          ...
          <div className="flex justify-center items-center">
            {isLoading ? (
              ...
              <img
                src={systemImg}
                alt="Live Weather"
                className="w-full md:h-96 lg:h-[500px] object-cover rounded-lg shadow-md transform hover:scale-105 transition-all duration-500"
              />
            ) : (
